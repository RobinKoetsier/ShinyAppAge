...
ScatterShinyOtherDark <- function(data,color1,color2,color3,color4,color5,teamname,alpha,left,right){
...
ScatterShinyTimeOtherDark <- function(data,color1,color2,color3,color4,color5,teamname,alpha,left,right){
  #data<- all_team_minutes
  teamname <- gsub("-"," ",teamname)
...
ScatterShinyContractOtherDark <- function(data,color1,color2,color3,color4,color5,teamname,alpha,left,right){
  #data<- all_team_minutes
  teamname <- gsub("-"," ",teamname)
...
ScatterShinyNoOtherDark <- function(data,color1,color2,color3,color4,color5,teamname,alpha,left,right){
  #data<- all_team_minutes
  teamname <- gsub("-"," ",teamname)
